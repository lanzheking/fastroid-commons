 ...
 */
public class ShareActionExecutor extends JSActionAbstractExecutor<JSActionParamBean>{
    @Override
    public void execute(Context context,JSActionParamBean shareParamBean) {
